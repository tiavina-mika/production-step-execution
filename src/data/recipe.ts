      ...
      steps: [
        {
          ...
          ingredients: [
            {
              index: "9d455456-2820-49f8-8725-87423c185ccc",
              grossWeight: 1,
              cookingMode: "DInHvLSktg",
              priorSteps: null,
              supplierItem: {
                id: "tRF4guLsU8",
                ...
                commercialName: "Pas de nom commercial",
                allergens: [
                  {
                    allergenId: "EIxjDMlPHC",
                    name: "gluten"
                  },
                  {
                    allergenId: "2iTagKlOnf",
                    name: "lait"
                  },
                  {
                    allergenId: "phERXfCgTi",
                    name: "oeuf"
                  }
                ],
                complexity: 1
      ...
      productionSteps: [
        {
          step: {
            objectId: "RLDCI3ugWW",
            name: "Step 01",
            index: "ffac0e85-4fa8-4067-ae53-57cfcfb84755",
            description: "",
            stepComponents: [
              {
                index: "e01277ca-838a-4e5c-959d-fca56b89c85c",
                grossWeight: 0.011235955056179775,
                cookingMode: null,
                priorSteps: null,
                supplierItem: {
                  id: "tKFVbHYlIP",
                  ...
                  allergens: [
                    {
                      allergenId: "0hDAAVnTxb",
                      name: "crustacé"
                    },
                    {
                      allergenId: "8lAAk4buZd",
                      name: "céleri"
                    },
                    {
                      allergenId: "FlS9JwJzXD",
                      name: "fruit à coque"
                    },
                    {
                      allergenId: "EIxjDMlPHC",
                    ...
                    {
                      allergenId: "x5wpNATC82",
                      name: "poisson"
                    },
                    {
                      allergenId: "jDw1w4OYdW",
                      name: "soja"
                    },
                    {
                      allergenId: "VM6f1jg9XA",
                      name: "sulfite"
                    },
                    {
                      allergenId: "EvK4tB6k9Q",
                      name: "sésame"
                    }
                  ],
                  complexity: 3,
                ...
                netWeight: 0.01,
                error: false,
                cost: 0.011235955056179775,
                realCost: 0.011235955056179775,
                cookingModeLabel: ""
              }
            ],
            error: true,
            ...
            netWeight: 0.01,
            totalNetWeight: 0.01,
            totalGrossWeight: 0.01124,
            cost: 0.011235955056179775,
            realCost: 0.011235955056179775,
            totalInputWeight: 0.01124,
            totalOutputWeight: 0.01,
            stepNumber: 1
          },
          reusable: false,
          netWeight: 0.01,
        ...
        },
        {
          step: {
            objectId: "oLbNZboeKE",
            name: "Step 02",
            index: "69ebd787-84aa-4ad4-bfe2-d76f8e4c928f",
            description: "Test step 02",
            stepComponents: [
              {
                index: "c99b8487-a7cb-4d98-9d9d-6d109acbe944",
                grossWeight: 0.01,
                cookingMode: null,
                priorSteps: {
                  objectId: "RLDCI3ugWW",
                  ...
                  stepComponents: [
                    {
                      ...
                      supplierItem: {
                        id: "tKFVbHYlIP",
                        index: "05944b9c-a145-41ba-a4ed-68cb95769f9e",
                        name: "x-poireaux",
                        pricePerKg: 1,
                        cookingModes: [
                          {
            ...
            stepDurationUnit: "kg / heure",
            netWeight: 0.0089,
            totalNetWeight: 0.0089,
            totalGrossWeight: 0.01,
            cost: 0,
            realCost: 0,
            totalInputWeight: 0.01,
            totalOutputWeight: 0.0089,
            stepNumber: 2
          },
          reusable: false,
          netWeight: 0.0089,
        ...
        },
        {
          step: {
            objectId: "HaNZhwfBCk",
            name: "Step 5",
            index: "bbe1a52e-2218-4187-9da6-b15aee59f0c7",
            description: "Step 5 descriiption",
            stepComponents: [
              {
                index: "620a6df5-3a5e-4268-8da8-20f451498455",
                grossWeight: 0.0089,
                cookingMode: null,
                priorSteps: {
                  objectId: "oLbNZboeKE",
            ...
            machineType: {
              name: "Cuiseur pâtes",
              createdAt: "2022-08-19T08:34:11.283Z",
              updatedAt: "2022-08-23T07:27:24.652Z",
              objectId: "TJsBwNBqwv",
              __type: "Object",
              className: "MachineTypes"
            },
